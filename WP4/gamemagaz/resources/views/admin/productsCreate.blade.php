...
@section('main-content')
    ...
    <div class="row">
        <div class="col-lg-8">
            <form id="productForm" enctype="multipart/form-data" method="POST"  action="{{route('admin.products.store')}}">
                {{csrf_field()}}
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="form-group">
                ...
                <textarea form="productForm" name="description" id="inputDesc" placeholder="Описание" class="form-control" rows="10"></textarea>
            </div>
        </div>
        <div class="col-lg-4">
            ...
            <input type="text" form="productForm" class="form-control" name="price" id="price">
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
